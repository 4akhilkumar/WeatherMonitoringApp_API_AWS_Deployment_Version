...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 class="header-title text-center">
                Admin Login&nbsp;<span class="akira">καιρός!</span>
            </h1>
        ...
        <form name="f" method="post" action="/admin-login">
            <div class="input app-input">
                <input type="text" name="username" id="id_username" autocapitalize="none" onkeyup="isEmpty()" required>
                <label for="username"><i class="far fa-user"></i> Username</label>
            </div>
    
            <div class="input app-input">
                <input type="password" name="password" id="id_password" onkeyup="isEmpty()" required>
    ...
    <script src="pages/static/login.js"></script>
</body>
</html>